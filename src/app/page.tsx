...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-24 bg-black/95 text-orange-300">
      ...
      <div className="z-10 w-full max-w-5xl items-center justify-between bg-gray-600 border-solid border-2 border-orange-300 rounded-md p-4 font-mono text-sm lg:flex">
        <p className="fixed left-0 top-0 bg-black/95 flex w-full justify-center border-b border-orange-300 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4">
